    ...
    return (
        <figure className={cn(cardClasses({ type, selected }))}>
            <div className="price-card__bg">
                <div className="relative flex flex-col items-left gap-8 py-8 border-2 rounded-[24px] w-[304px] h-[579px]">
                    ...
                    <div className="px-6 w-full flex flex-col">
                        <Button variant={selected ? "primary": "fatal-outline"} onClick={onSelect}>{select}</Button>
                    </div>
                </div>
            </div>
        </figure>
